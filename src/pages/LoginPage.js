  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-yellow-50 p-4 font-sans" style={{'--brand-purple': themeColors.brandPurple, '--brand-purple-hover': themeColors.brandPurpleHover }}>
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md relative">
        ...
        <div className="text-center mb-6 pt-4"> <a href="#" className="text-3xl font-semibold text-[--brand-purple] hover:text-[--brand-purple-hover] transition-colors">clientwise</a> <h2 className="mt-2 text-xl font-semibold text-gray-700">{isSignUp ? 'Create Account' : 'Login'}</h2> </div>
