...
const CommandCenterSection = () => (
    <section id="command-center" className="bg-gray-50 py-16 lg:py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
             <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-[--brand-purple] mb-6 animate-on-scroll" style={{'--brand-purple': themeColors.brandPurple}}> why ClientWise AI </h2>
